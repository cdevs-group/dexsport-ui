...
export const Default: React.FC = () => {
  ...
  return (
    <>
      ...
      <Row>
        <ButtonMenu activeIndex={index} onItemClick={handleClick} color="subtle">
          <ButtonMenuItem>Button 1</ButtonMenuItem>
          <ButtonMenuItem>Button 2</ButtonMenuItem>
          <ButtonMenuItem>Button 3</ButtonMenuItem>
          <ButtonMenuItem>Button 4</ButtonMenuItem>
      ...
      <Row>
        <ButtonMenu activeIndex={index1} onItemClick={handleClick1} scale="sm" color="subtle" ml="24px">
          <ButtonMenuItem>Button 1</ButtonMenuItem>
          <ButtonMenuItem>Button 2</ButtonMenuItem>
          <ButtonMenuItem>Button 3</ButtonMenuItem>
          <ButtonMenuItem>Button 4</ButtonMenuItem>
...
export const DisabledMenu: React.FC = () => {
  ...
  return (
    <>
      ...
      <Row>
        <ButtonMenu disabled activeIndex={index1} onItemClick={handleClick1} scale="sm" color="subtle" ml="24px">
          <ButtonMenuItem>Disabled 1</ButtonMenuItem>
          <ButtonMenuItem>Disabled 2</ButtonMenuItem>
          <ButtonMenuItem>Disabled 3</ButtonMenuItem>
          <ButtonMenuItem>Disabled 4</ButtonMenuItem>
...
export const FullWidthMenu: React.FC = () => {
  ...
  return (
    <Box width="840px">
      ...
      <ButtonMenu activeIndex={index} fullWidth scale="sm" color="subtle">
        <ButtonMenuItem as="a" href="https://pancakeswap.finance">
          Link 1
        </ButtonMenuItem>
        <ButtonMenuItem as="a" href="https://pancakeswap.finance">
