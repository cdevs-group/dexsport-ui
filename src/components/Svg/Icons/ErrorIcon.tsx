...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg width="42px" height="42" viewBox="0 0 42 42" fill="#F45555" {...props}>
      <rect x="6" y="6" width="30" height="30" rx="7" fill="url(#paint0_linearErrorIcon)" />
      <g filter="url(#filter0_dErrorIcon)">
      ...
      <defs>
        ...
        <linearGradient id="paint0_linearErrorIcon" x1="21" y1="6" x2="21" y2="36" gradientUnits="userSpaceOnUse">
